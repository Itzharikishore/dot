...
router.get('/list', protect, getChildrenList); // Enhanced list with pagination
router.post('/create', protect, createValidators, createChildFrontend); // Frontend create endpoint
 ...
 *     description: Search children by name
 *     tags: [Children]
 *     security:
 *       - bearerAuth: []
 *     parameters:
...
/**
 * @swagger
 * /api/children/{id}/progress:
 *   get:
 *     summary: Get child progress
 *     description: Get progress statistics for a child
 *     tags: [Children]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *                       format: date
 */
router.get('/:id/progress', protect, idValidator, getChildProgress);
